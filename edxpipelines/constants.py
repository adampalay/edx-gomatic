...
CONFIGURE_DYNAMIC_SCALING_STAGE_NAME = 'configure_dynamic_scaling'
CONFIGURE_DYNAMIC_SCALING_JOB_NAME = 'configure_dynamic_scaling_job'
...
CONFIGURE_DYNAMIC_SCALING_OUT_FILENAME = 'dynamic_scaling_info.yml'
